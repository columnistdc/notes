      ...
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-4 flex items-center gap-2 md:right-5">
          ...
          <button
            type="button"
            onClick={onDelete}
            aria-label={`Delete memo "${label}"`}
            title={`Delete memo "${label}"`}
            className="pointer-events-auto flex h-8 w-8 items-center justify-center rounded-full text-slate-400 transition hover:bg-red-50 hover:text-red-600 focus:bg-red-50 focus:text-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
